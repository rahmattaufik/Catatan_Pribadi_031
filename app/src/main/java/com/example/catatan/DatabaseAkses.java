...
public class DatabaseAkses {
    ...
    private static volatile DatabaseAkses instance;

    private DatabaseAkses(Context context){
        this.openHelper = new DatabaseOpenHelper(context);
    }

    public static synchronized DatabaseAkses getInstance(Context context){
        if (instance == null){
            instance = new DatabaseAkses(context);
        }
        return instance;
    }
